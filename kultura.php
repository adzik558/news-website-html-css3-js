...
<head>
    <meta charset="utf-8">
    <title>AdrNews - Kultura i sztuka</title>
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle nav-item nav-link active" data-toggle="dropdown">Kultura i sztuka</a>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/kul1.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="kultura.php">Kultura i sztuka</a>
                                <a class="text-body" href="kultura.php">Sty 23 2023</a>
                            </div>
                         <a id="jackson" href="https://www.msn.com/pl-pl/rozrywka/news/filmowa-biografia-jacksona-nie-pominie-kontrowersji/ar-AA16Aupq?li=BBr5HD1" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">FILMOWA BIOGRAFIA JACKSONA NIE POMINIE KONTROWERSJI</h1></a>
                     Zdjęcia ruszą jeszcze w tym roku. Film ma przedstawiać najważniejsze wydarzenia z życia artysty od Jackson 5 aż do jego szokującej śmierci w wieku 50 lat. W filmie nie zabraknie kontrowersji. Sprawa oskarżeń o pedofilię, o których było głośno, nie zostanie pominięta.
                        </div>
