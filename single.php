            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle nav-item nav-link active" data-toggle="dropdown">Sport</a>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/sport1.png" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                    href="single.php">Sport</a>
                                <a class="text-body" href="single.php">Sty 23 2023</a>
                            </div>
                         <a id="lewy" href="https://sportowefakty.wp.pl/pilka-nozna/1041501/lewandowski-dorownal-ibrahimoviciowi-co-za-wynik" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Lewandowski dorównał Ibrahimoviciowi. Co za wynik!</h1></a>
                       Robert Lewandowski w meczu Pucharu Króla AD Ceuta - FC Barcelona strzelił dwie bramki. Polski napastnik ma już na koncie 22 trafienia i goni w tabeli najlepszych strzelców w historii klubu z Camp Nou.
                        </div>
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <div class="d-flex align-items-center">
					           ...
					           <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/news-800x500-1.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                    href="single.php">Sport</a>
                          ...
                          <a id="ronaldo" href="https://www.sport.pl/pilka/7,64946,29341288,znamy-termin-debiutu-cristiano-ronaldo-w-al-nassr-krychowiak.html" target="blank">  <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Znamy termin debiutu Cristiano Ronaldo w Al-Nassr</h1></a>
                     Trener Al-Nassr, Rudi Garcia, potwierdził datę debiutu Cristiano Ronaldo w nowym klubie. Portugalczyk najpierw zagra w towarzyskim spotkaniu przeciwko Paris Saint-Germain, a później po raz pierwszy wystąpi w meczu Saudi Pro League. Ronaldo ominie mecz z drużyną Grzegorza Krychowiaka.
                        </div>
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle mr-2" src="img/user.jpg" width="25" height="25" alt="">
                        ...
                        <div class="bg-white border border-top-0 p-4">
                          ...
                          <a id="swiatek" href="https://sportowefakty.wp.pl/tenis/1041559/iga-swiatek-nie-podbije-melbourne-mistrzyni-wimbledonu-pokazala-moc-swojego-retu" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Iga Świątek nie podbije Melbourne. Mistrzyni Wimbledonu pokazała moc swojego returnu</h1></a>
                     Iga Świątek nie wygra w tym roku Australian Open. W niedzielę w Melbourne polska tenisistka uległa Jelenie Rybakinie w starciu wielkoszlemowych mistrzyń.
                        </div>
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle mr-2" src="img/user.jpg" width="25" height="25" alt="">
					    ...
					    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/sport2.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                    href="single.php">Sport</a>
                          ...
                          <a id="zyla" href="https://i.pl/puchar-swiata-w-sapporo-piotr-zyla-zajal-osme-miejsce/gh/c1-17222389" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Puchar Świata w Sapporo. Piotr Żyła zajął ósme miejsce</h1></a>
                Piotr Żyła zajął ósme miejsce w niedzielnym konkursie Pucharu Świata w skokach narciarskich w Sapporo. Zwyciężył Japończyk Ryoyu Kobayashi. Prowadzący w klasyfikacji generalnej Dawid Kubacki był 11.
                        </div>
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle mr-2" src="img/user.jpg" width="25" height="25" alt="">
                        ...
                        <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/sport69.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                    href="single.php">Sport</a>
                          ...
                          <a id="mundial" href="https://przegladsportowy.onet.pl/pilka-reczna/mistrzostwa-swiata-pilkarzy-recznych/slabe-pozegnanie-z-mundialem-polacy-ograli-iran/j2rxb1h" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Słabe pożegnanie z mundialem. Polacy ograli Iran</h1></a>
                          Zwycięstwem nad drużyną Iranu 26:22 (16:10) pożegnała się z mistrzostwami świata reprezentacja Polski piłkarzy ręcznych. Biało-Czerwoni w turnieju wygrali więc łącznie trzy spotkania — z Arabią Saudyjską, Czarnogórą i właśnie Iranem.
                        </div>
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle mr-2" src="img/user.jpg" width="25" height="25" alt="">
