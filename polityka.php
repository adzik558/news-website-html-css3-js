            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle nav-item nav-link active" data-toggle="dropdown">Polityka</a>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/pol1.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="polityka.php">Polityka</a>
                                <a class="text-body" href="polityka.php">Sty 23 2023</a>
                            </div>
                         <a id = "putin" href="https://i.pl/putin-mowi-o-zakonczeniu-wojny-mieknie-czy-to-kolejny-blef/ar/c1-17151139" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Putin mówi o zakończeniu wojny. Mięknie, czy to kolejny blef?
</h1></a>
                 Na spotkaniu z dziennikarzami w Moskwie Putin mówił o potrzebie zakończenia wojny na Ukrainie. Reakcja Waszyngtonu była natychmiastowa. Na horyzoncie nie widać oznak, by agresor odpuścił UKrainie.
                        </div>
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
					        ...
					        <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/pol2.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="polityka.php">Polityka</a>
                         ...
                         <a id="premier" href="https://www.pap.pl/aktualnosci/news%2C1524740%2Cpremier-dla-pap-jesli-nie-bedzie-zgody-niemiec-ws-leopardow-zbudujemy" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Premier dla PAP: jeśli nie będzie zgody Niemiec ws. Leopardów, zbudujemy mniejszą koalicję
</h1></a>
                Jeśli nie będzie zgody Niemiec w sprawie Leopardów, będziemy budować "mniejszą koalicję" państw gotowych przekazać część swoich nowoczesnych czołgów dla walczącej Ukrainy. Nie będziemy patrzeć biernie, jak Ukraina się wykrwawia. Ukraina i Europa wygrają tę wojnę – z Niemcami czy bez
                        </div>
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle mr-2" src="img/user.jpg" width="25" height="25" alt="">
