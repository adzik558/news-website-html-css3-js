            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle nav-item nav-link active" data-toggle="dropdown">Rozrywka</a>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/roz1.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="rozrywka.php">Rozrywka</a>
                                <a class="text-body" href="rozrywka.php">Sty 23 2023</a>
                            </div>
                         <a id= "cdprojekt" href="https://www.benchmark.pl/aktualnosci/cyberpunk-2077-widmo-wolnosci-to-najdrozsze-dlc-cd-projekt.html" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">CD Projekt nie poskąpi pieniędzy na Cyberpunk 2077: Widmo Wolności
</h1></a>
               Bardzo powoli spływają informacje na temat Cyberpunk 2077: Widmo Wolności, ale jeśli już się pojawiają, to okazują się bardzo interesujące.
                        ...
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <div class="d-flex align-items-center">
					          ...
					          <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/roz2.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="rozrywka.php">Rozrywka</a>
                         ...
                         <a id = "ferie" href="https://www.portaloswiatowy.pl/wazne-wydarzenia-dla-szkol-i-przedszkoli/ferie-zimowe-w-roku-szkolnym-20222023-od-16-stycznia-22650.html" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Ferie zimowe w roku szkolnym 2022/2023 od 16 stycznia
</h1></a>
           Przypominamy o terminach ferii zimowych w roku szkolnym 2022/2023. Okres ferii rozpocznie się 16 stycznia i zakończy 26 lutego 2023 r.
