            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle nav-item nav-link active" data-toggle="dropdown">Kuchnia</a>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/kuch1.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="kuchnia.php">Kuchnia</a>
                                <a class="text-body" href="kuchnia.php">Sty 23 2023</a>
                            </div>
                         <a id = "jedzenie" href="https://stronazdrowia.pl/pyszne-i-kaloryczne-bakalie-suszone-owoce-maja-mnostwo-zalet-ale-nie-mozna-jesc-ich-bez-umiaru-komu-moga-szczegolnie-szkodzic/ar/c14-15888157" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Pyszne i kaloryczne – bakalie. Suszone owoce mają mnóstwo zalet, ale nie można jeść ich bez umiaru. Komu mogą szczególnie szkodzić?
</h1></a>
             Suszone owoce to – obok orzechów – główny składnik bakalii. Są pożywnym źródłem wielu składników odżywczych. Jednak nie można jeść ich bez umiaru, bo większość z nich jest bardzo kaloryczna. Poznaj słodkie tajemnice, które skrywają w sobie: daktyle i śliwki suszone, a także suszone jabłko, banan oraz figi, morele, rodzynki, żurawina i jagody goji.
