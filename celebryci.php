            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle nav-item nav-link active" data-toggle="dropdown">Celebryci</a>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/cel1.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="celebryci.php">Celebryci</a>
                                <a class="text-body" href="celebryci.php">Sty 23 2023</a>
                            </div>
                         <a id="ksiezycowy" href="https://i.pl/ksiezycowy-czlowiek-sie-zeni-wszystkiego-najlepszego-panie-aldrin/ar/c1-17222419" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Księżycowy człowiek się żeni. Wszystkiego najlepszego, panie Aldrin
</h1></a>
             Buzz Aldrin, drugi człowiek, który stąpał po Księżycu (po Neilu Armstrongu) ożenił się po raz czwarty w swoje 93 urodziny. Jak przyznał legendarny astronauta on i jego żona, Anca Faur, byli „podekscytowani jak uciekający nastolatkowie”.
                        ...
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
					        ...
					        <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/cel2.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="celebryci.php">Celebryci</a>
                         ...
                         <a id="ksiazka" href="https://www.plotek.pl/plotek/7,154063,29375693,zabojca-agnieszki-kotlarskiej-wypozyczyl-ksiazke-o-jej-sprawie.html" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Zabójca Agnieszki Kotlarskiej wypożyczył książkę o jej sprawie. Zostawił wiadomość. "Przebieg morderstwa inny"
</h1></a>
            Zabójstwo Agnieszki Kotlarskiej wstrząsnęło Polską. Sprawca nie tylko jest na wolności, ale w znalezionym w bibliotece egzemplarzu książki odniósł się do reportażu opisującego sprawę zamordowanej miss.
