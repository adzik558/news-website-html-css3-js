            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle nav-item nav-link active" data-toggle="dropdown">Świat</a>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/swat1.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="swiat.php">Świat</a>
                                <a class="text-body" href="swiat.php">Sty 23 2023</a>
                            </div>
                         <a id = "zabojstwo" href="https://tvn24.pl/pomorze/inowroclaw-zabojstwo-10-latki-ojciec-przyznal-sie-do-zbrodni-i-wyskoczyl-z-okna-6642787" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Zabójstwo 10-letniej dziewczynki. Do tragedii doszło w sobotę rano
</h1></a>
           52-latek zadzwonił w sobotę rano na numer alarmowy 112 i powiedział operatorowi, że zabił swoją córkę - poinformowała kujawsko-pomorska policja. Funkcjonariusze po wejściu do mieszania znaleźli zwłoki 10-latki.

                        </div>
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle mr-2" src="img/user.jpg" width="25" height="25" alt="">
                                <span>Adrian Dereń</span>
                            </div>
					     ...
					     <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/swat2.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="swiat.php">Świat</a>
                         ...
                         <a id = "alarm" href="https://www.polsatnews.pl/wiadomosc/2023-01-22/alarm-bombowy-na-pokladzie-samolotu-lecacego-z-katowic-do-aten/" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Alarm bombowy na pokładzie samolotu lecącego z Katowic do Aten
</h1></a>
       "Na pokładzie samolotu linii Ryanair lecącego z Polski do Grecji zgłoszono alarm bombowy" - podała w niedzielę po południu agencja AFP. Maszyna wylądowała bezpiecznie na międzynarodowym lotnisku w Atenach. Specjalne jednostki policji dokonują inspekcji samolotu i bagażu.
                        ...
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <div class="d-flex align-items-center">
						     ...
						     <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/swat3.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="swiat.php">Świat</a>
                         ...
                         <a id="zima" href="https://korso24.pl/na-sygnale/zimowy-paraliz-na-podkarpaciu-wciaz-tysiace-gospodarstw-domowych-jest-bez-pradu-zdjecia/F8egkn5fJAcQDj7xW9Lg" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Zimowy paraliż na Podkarpaciu. Wciąż tysiące gospodarstw domowych jest bez prądu
</h1></a>
     Intensywne opady śniegu, w nocy z piątku na sobotę, spowodowały utrudnienia na drogach oraz awarie linii elektroenergetycznych. W województwie podkarpackim bez prądu było nawet 120 tysięcy mieszkańców. Służby nadal mają mnóstwo pracy. - Podkarpacie, Rzeszów, Tarnobrzeg, Stalowa Wola - wiadomości, informacje, wydarzenia
                    ...
                    <div class="position-relative mb-3">
               <img class="img-fluid w-100" src="img/news-800x500-3.jpg" style="object-fit: cover;">
               <div class="bg-white border border-top-0 p-4">
                   <div class="mb-3">
                       <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                          href="swiat.php">Świat</a>
                ...
                <a id="zima" href="https://wydarzenia.interia.pl/lubuskie/news-tragiczny-wypadek-z-udzialem-pojazdu-armii-usa-dwie-osoby-ni,nId,6548736" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Tragiczny wypadek z udziałem pojazdu armii USA. Dwie osoby nie żyją
</h1></a>
Dwie osoby zginęły w wyniku zderzenia pojazdu typu kamper z pojazdem ciężarowym armii USA na drodze ekspresowej S3 na wysokości Skwierzyny w województwie lubuskim. Kamper prawdopodobnie najechał na tył samochodu sił zbrojnych USA z przyczepą
               </div>
               <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                   <div class="d-flex align-items-center">
                       <img class="rounded-circle mr-2" src="img/user.jpg" width="25" height="25" alt="">
                       <span>Adrian Dereń</span>
						     ...
						     <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/swat4.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="swiat.php">Świat</a>
                         ...
                         <a id="ukraina" href="https://tvn24.pl/najnowsze/wojna-rosja-ukraina-najwazniejsze-wydarzenia-ostatnich-godzin-6016453" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Ukraina. Najważniejsze wydarzenia ostatnich godzin
</h1></a>
  Agresja Rosji na Ukrainę trwa od 159 dni. Prezydent Ukrainy Wołodymyr Zełenski poinformował, że minionej doby doszło do jednego z najpotężniejszych ostrzałów Mikołajowa i obwodu mikołajowskiego od początku pełnowymiarowej rosyjskiej inwazji. Wezwał ludzi zamieszkujących obwód doniecki do opuszczenia tego regionu. Z kolei ukraińska armia ostrzela...
                        ...
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
					     ...
					     <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/swat5.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="swiat.php">Świat</a>
                         ...
                         <a id="strzelanina" href="https://gs24.pl/w-stanach-zjednoczonych-doszlo-do-strzelaniny-podczas-obchodow-chinskiego-nowego-roku-sa-ofiary-smiertelne/ar/c1-17222917" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">W Stanach Zjednoczonych doszło do strzelaniny podczas obchodów chińskiego nowego roku. Są ofiary śmiertelne
</h1></a>
 Dziesięć osób zostało zabitych w strzelaninie w mieście Monterey Park na wschód od Los Angeles w USA - podały w niedzielę lokalne władze. Według lokalnych mediów tragedia miała miejsce w klubie tanecznym. W rejonie tym w sobotę rozpoczął się dwudniowy festiwal, który dla tamtejszych mieszkańców pochodzących z Azji jest jednym z największych obchodów chińskiego Nowego Roku.
                        ...
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <div class="d-flex align-items-center">
						     ...
						     <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/swat6.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="swiat.php">Świat</a>
                         ...
                         <a id="oleksij" href="https://wiadomosci.wp.pl/oleksij-danilow-ostrzega-ukraine-chca-nas-zniszczyc-6858347658422848a" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">Ołeksij Daniłow ostrzega Ukrainę. "Chcą nas zniszczyć"
</h1></a>
Sekretarz Rady Bezpieczeństwa Narodowego i Obrony Ukrainy Ołeksij Daniłow napisał felieton "Strategia Putina - 2023", który jest głośno komentowany w ukraińskich mediach. Według Daniłowa Moskwa przygotowuje
                        ...
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
					     ...
					     <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/swat7.jpg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                   href="swiat.php">Świat</a>
                         ...
                         <a id="kaliningrad" href="https://www.onet.pl/informacje/olsztyncom/w-kaliningradzie-bez-zmian-inflacja-recesja-poszukiwanie-zdrajcow/k6136ge,30bc1058?105" target="blank">    <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">W Kaliningradzie bez zmian: inflacja, recesja, poszukiwanie zdrajców
</h1></a>
Obwód kaliningradzki przeżywa obecnie trudny czas. Oddzielony jest od zasadniczej części Rosji dwoma granicami. To generuje problemy transportowe — praktycznie zablokowany jest tranzyt towarowy przez Litwę i Polskę. W regionie spada PKB. Wedle wyliczeń specjalistów ten wskaźnik za ubiegły rok może obniżyć się o co najmniej 12 proc. Pesymiści mów...
